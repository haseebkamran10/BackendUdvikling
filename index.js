...
const authRoutes = require('./backend/user-auth/routes/authRoutes');
const orderRoutes = require('./backend/order-management/routes/orderRoutes'); // Add this line

// Import Supabase client (before authRoutes)
const supabase = require('./backend/user-auth/services/supabaseClient');
